...
//  FlappyBird
//
//  Created by Devesh Shetty on 29/12/20.
//
...
final class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    private var gameState = GameState.showingLogo
    
    private let rockTexture = SKTexture(imageNamed: "rock")
    private var rockPhysics: SKPhysicsBody!
    private let explosion = SKEmitterNode(fileNamed: "PlayerExplosion")
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if contact.bodyA.node == player || contact.bodyB.node == player {
            if let explosion = explosion?.copy() as? SKEmitterNode {
